...
projdir="/scratch/projects/and_transcriptomics/Ch4_AcerCCC/2_trimmed_reads"
...
${and}/Ch4_AcerCCC/0_scripts/tagseq_clipper.pl ${samp}_temp.fastq | cutadapt - -a AAAAAAAA -a AGATCGG -q 15 -m 25 -o ${projdir}/${samp/.fastq.gz/}.trim
