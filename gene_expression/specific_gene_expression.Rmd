...
Location_CCC_vs_Nursery <- read_csv("Location_CCC_vs_nursery_annotDGEs.csv")
...
results <- results(dds, contrast=c("Location", "CCC", "nursery"))
...
```{r}
Acropora_000806_counts <- significant_counts["Acropora_000806",]

df_Acropora_000806 <- data.frame(expression_level = Acropora_000806_counts)

df_Acropora_000806 %>% 
  rownames_to_column(var="Sample") -> df_Acropora_000806

design %>% 
  rownames_to_column(var="Sample") -> design
  
full_join(design, df_Acropora_000806) %>% 
